defmodule ElixirTools.SchemaTest do
  ...
  alias ElixirTools.Schema.{TestSchema, TestRepo}
  ...
  describe "repo/1" do
    test "returns default" do
      assert TestSchema.repo() == TestRepo
    end
  end
  ...
  describe "validate/1" do
    test "returns :ok when tuple is valid" do
      ...
      assert TestSchema.validate(valid_input) == :ok
    end
  ...
  describe "create!/1" do
    ...
    test "inserts the value if it is a valid map" do
      ...
      expected = %ElixirTools.TestSchema{
        id: nil,
        test_field_1: "1",
        test_field_2: "2",
        test_field_3: "3"
